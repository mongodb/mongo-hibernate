...
@DomainModel(annotatedClasses = {SelectionLocalDateIntegrationTest.Item.class})
public class SelectionLocalDateIntegrationTest
        extends AbstractSelectionTemporalIntegrationTest<SelectionLocalDateIntegrationTest.Item, LocalDate> {

    public static final List<Item> ITEMS = List.of(
            new Item(1, LocalDate.of(2025, 1, 4)),
            new Item(2, LocalDate.of(2025, 5, 4)),
            new Item(3, LocalDate.of(2025, 12, 4)));
    ...
    public static Stream<Arguments> testComparisonByEq() {
        return Stream.of(
                Arguments.of(
                        ...
                        Item.class),
                // timezone has no effect on LocalDate comparison
                Arguments.of(
                        LocalDate.of(2025, 1, 4),
    ...
    static class Item {
        ...
        public Item(int id, LocalDate temporal) {
            this.id = id;
