...
@DomainModel(
        annotatedClasses = {
            MongoIdFieldNameTests.EntityWithoutIdColumnAnnotation.class,
            MongoIdFieldNameTests.EntityWithIdColumnAnnotationWithoutNameProperty.class,
            MongoIdFieldNameTests.EntityWithIdColumnAnnotationWithNamePropertyIdentical.class
        })
class MongoIdFieldNameTests {
