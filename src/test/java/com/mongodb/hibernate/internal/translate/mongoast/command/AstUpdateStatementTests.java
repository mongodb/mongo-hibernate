...
class AstUpdateStatementTests {

    @Test
    void testMapChildren() {
        assertMapsChildren(new AstUpdateStatement(
                new AstExprFilter(new AstFieldPathExpression("f")), new AstPipelineUpdate(List.of()), UPSERT));
    }
}
