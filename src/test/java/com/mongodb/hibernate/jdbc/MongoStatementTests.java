...
class MongoStatementTests {
    ...
    @Test
    @DisplayName("no exception should be thrown when close() method called on a MongoStatement which has been closed")
    ...
    class ExecuteUpdateTests {
        ...
        @Test
        @DisplayName("SQLException is thrown when 'mql' is null")
        void testSQLExceptionThrownWhenCalledWithNull() {

            // given

            // when && then
            assertThrows(SQLException.class, () -> mongoStatement.executeUpdate(null));
        }
        ...
        @Test
        @DisplayName("SQLException is thrown when command is unknown")
        void testSQLExceptionThrownWhenCommandUnknown() {
        ...
        @Test
        @DisplayName("SQLException is thrown when statement has been closed")
        ...
        @Test
        @DisplayName("SQLException is thrown when database access fails")
